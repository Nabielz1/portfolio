            ...
            <div className="p-4">
              ...
              <div className="flex gap-2 mb-4">
                {project.tech.map((tech, idx) => (
                  <span key={idx} className="bg-gray-200 text-gray-800 py-1 px-3 rounded-full text-xs">{tech}</span>
                ))}
              </div>
              <a href={project.github} target="_blank" rel="noopener noreferrer" className="text-white bg-gray-700 rounded-sm px-4 py-2 hover:underline">GitHub</a>
            </div>
          </div>
        ))}
      </div>
